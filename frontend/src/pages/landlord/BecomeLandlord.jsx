...
export default function BecomeLandlord() {
  return (
    <div>
      <div className="max-w-7xl mx-auto my-40 bg-indigo-900 relative rounded-2xl p-10">
        ...
        <h1 className="text-center text-4xl mt-8 tracking-wider font-bold text-white">
        ...
        <div className="flex justify-center items-center gap-2">
          <Link
            to="/signup"
            className="bg-yellow-300 text-black px-6 py-3 rounded-full shadow-lg hover:bg-yellow-400 hover:shadow-2xl transition duration-300   mt-6 flex items-center gap-2"
          >
          ...
          <Link
            to="/signup"
            className="bg-black/30 text-taupe-100 px-6 py-3 rounded-full hover:shadow-2xl mt-6 boder flex items-center gap-2"
          >
            <Play />
            See How It Works
          </Link>
