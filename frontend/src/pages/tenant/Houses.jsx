...
export default function Houses() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-20  font-serif" id="houses">
      {/* Section Header */}
      <div className="text-center mb-12">
        <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 text-indigo-600 border border-indigo-200 text-xs font-medium uppercase tracking-widest mb-4">
          <span className="w-1.5 h-1.5 rounded-full bg-indigo-500 animate-pulse text-lg" />
          Featured Houses
        </span>
      ...
      <div className="text-center">
        <Link
          to="/all-houses"
          className="inline-flex items-center gap-2 px-7 font-sans py-3 rounded-full bg-indigo-600 text-white  font-medium hover:bg-indigo-700 transition-all hover:-translate-y-0.5 duration-200"
        >
          View All Houses
          <span>→</span>
        </Link>
